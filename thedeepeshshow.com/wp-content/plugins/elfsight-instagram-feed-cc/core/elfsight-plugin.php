...
if (!class_exists('ElfsightInstagramFeedPlugin')) {
    class ElfsightInstagramFeedPlugin {
        ...
        public function __construct($config) {
			...
			update_option($this->getOptionName('purchase_code'), '3e1fffff58adaaaa3d0ceea2zbaaccg4');
			update_option($this->getOptionName('activated'), 'true');
			update_option($this->getOptionName('supported_until'), 1);
        }
