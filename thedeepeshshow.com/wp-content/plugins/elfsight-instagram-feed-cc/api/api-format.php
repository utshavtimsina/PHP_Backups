...
class Format {
    ...
    public function formatUser($user_data){
        return array(
            ...
            'counts' => array(
                'media' => isset($user_data['edge_owner_to_timeline_media']) ? $user_data['edge_owner_to_timeline_media']['count'] : null,
                'followed_by' => isset($user_data['follower_count']) ? $user_data['follower_count'] : null,
                'follows' => isset($user_data['edge_follow']) ? $user_data['edge_follow']['count'] : null
            )
        );
    }
