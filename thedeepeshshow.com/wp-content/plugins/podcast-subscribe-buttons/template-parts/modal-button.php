...
<script>
	jQuery(document).ready(function($) {
		 'use strict';
		$('#podcast-subscribe-button-<?php echo $post->ID;?> .podcast-subscribe-button.<?php echo $secondline_unique_shortcode;?>').on("click", function() {
			$("#secondline-psb-subs-modal.<?php echo $secondline_unique_shortcode;?>.modal.secondline-modal-<?php echo $post->ID;?>").modal({
				fadeDuration: 250,
				closeText: '',
			});
			return false;
