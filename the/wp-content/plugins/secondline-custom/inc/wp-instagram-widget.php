...
if( ! function_exists('slt_wpiw_widget')) {
	function slt_wpiw_widget() {
		register_widget( 'slt_null_instagram_widget' );	
	}
	add_action( 'widgets_init', 'slt_wpiw_widget' );
}

Class slt_null_instagram_widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'slt-null-instagram-feed',
			__( 'Instagram', 'wp-instagram-widget' ),
			array(
				'classname' => 'slt-null-instagram-feed',
				'description' => esc_html__( 'Displays your latest Instagram photos by hash-tag', 'wp-instagram-widget' ),
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Instagram #tag', 'wp-instagram-widget' ); ?>: <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" /></label></p>
