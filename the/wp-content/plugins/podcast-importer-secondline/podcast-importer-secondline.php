 ...
 */
define( 'PODCAST_IMPORTER_SECONDLINE_VERSION', '1.1.1' );
...
function secondline_pis_notice() {
	if( ! function_exists('secondline_themes_setup') ) {
		...
		<div data-dismissible="disable-import-notice-120" class="notice notice-info is-dismissible">
			<p><?php esc_html_e( 'Boost your Podcast Website with a truly dedicated', 'secondline-pis-custom-buttons' ); ?> <a href="https://secondlinethemes.com/themes/?utm_source=import-plugin-notice" target="_blank"><?php esc_html_e( 'Podcast Theme.', 'secondline-pis-custom-buttons' );?></a> <?php esc_html_e( 'Brought to you by the creators of the Podcast Importer SecondLine plugin!', 'secondline-pis-custom-buttons' ); ?></p>
		</div>
		<?php
	}
}
