...
abstract class Api {
    ...
    public function initDebug($debug_mode) {
        if (class_exists('\ElfsightFacebookFeedApi\Debug')) {
            return new \ElfsightFacebookFeedApi\Debug($this, $debug_mode);
        } else {
            return new \ElfsightFacebookFeedApi\Core\Debug($this, $debug_mode);
        }
    }

    public function initOptions($config) {
        if (class_exists('\ElfsightFacebookFeedApi\Options')) {
            return new \ElfsightFacebookFeedApi\Options($this->Helper, $config);
        } else {
            return new \ElfsightFacebookFeedApi\Core\Options($this->Helper, $config);
        }
    }
