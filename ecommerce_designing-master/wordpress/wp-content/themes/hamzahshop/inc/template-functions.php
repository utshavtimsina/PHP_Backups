...
<option value="0"><?php _e('All Categories','hamzahshop') ?></option>
...
<?php } ?>
 ...
 <input type="search" name="s" id="text-search" value="<?php echo get_search_query(); ?>" placeholder="<?php _e('Search here...','hamzahshop') ?>" />
